      ...
      <div className="flex w-full justify-center mt-[2rem]">
        <div className="flex w-3/4  h-[4rem] justify-center items-center bg-secondary_700 text-black rounded-md ">
          <span className="w-1/2">
            <div className="w-[40px] sm:w-[50px] h-[40px] sm:h-[50px] bg-primary_200 rounded-full ml-3"> </div>
          </span>
          <span className="w-1/2 font-semibold text-sm sm:text-base"> Jhon Doe </span>
        </div>
      </div>
